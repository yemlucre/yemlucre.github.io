...
const BREW = {
  ...
  乌龙茶: {
    waterTemp: '100℃（东方美人等轻发酵乌龙宜 85-95℃）',
    utensil: '盖碗 / 紫砂壶',
  ...
  白茶: {
    waterTemp: '90 - 100℃（银针、牡丹约 90℃，贡眉、寿眉及老白茶宜沸水）',
    utensil: '盖碗 / 玻璃杯',
    ratio: '盖碗 5g 茶叶 : 110ml 水 / 玻璃杯 3g : 150ml',
    time: '盖碗首泡快出汤（银针可约 1 分钟），玻璃杯 1 - 2 分钟',
    steps: ['温杯：沸水烫洗茶具', '投茶：盖碗投约 5g，玻璃杯投约 3g', '注水：银针、牡丹约 90℃ 沿壁缓注，贡眉、寿眉及老白茶用 100℃ 沸水', '出汤：盖碗首泡 5-10 秒快出沥干（银针可静置约 1 分钟），玻璃杯静候 1-2 分钟', '品饮：新茶毫香清甜，老白茶枣香药香，亦可煮饮']
  },
  黑茶: {
    waterTemp: '100℃',
    utensil: '紫砂壶 / 盖碗',
